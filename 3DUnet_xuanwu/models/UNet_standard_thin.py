...
class UNet_standard_thin(nn.Module):
    def __init__(self, in_channel=1, out_channel=2, training=True):
        super(UNet_standard_thin, self).__init__()
        self.training = training
        self.channel_in_an_out = 32
        self.encoder1 = DoubleConv3d(in_channel, self.channel_in_an_out)
        self.encoder2 = DoubleConv3d(self.channel_in_an_out, self.channel_in_an_out*2)
        self.encoder3 = DoubleConv3d(self.channel_in_an_out*2, self.channel_in_an_out*4)
        self.encoder4 = DoubleConv3d(self.channel_in_an_out*4, self.channel_in_an_out*8)

        self.decoder1 = DoubleConv3d(self.channel_in_an_out*(4+8), self.channel_in_an_out*4, encoder=False)
        self.decoder2 = DoubleConv3d(self.channel_in_an_out*(2+4), self.channel_in_an_out*2, encoder=False)
        self.decoder3 = DoubleConv3d(self.channel_in_an_out*(1+2), self.channel_in_an_out, encoder=False)

        # conv_out
        self.conv_out = nn.Conv3d(self.channel_in_an_out, out_channel, 3, padding=1)
