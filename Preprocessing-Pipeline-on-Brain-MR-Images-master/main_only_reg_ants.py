...
def registration_ants_f(m_img_path, save_path, f_img_path):
    '''
...
if __name__ == '__main__':
    ...
    # input and anli
    input_anli_path = '/home/zhenghuadong/project/Preprocessing-Pipeline-on-Brain-MR-Images-master/data_dicom2nii/output_only3/output/'
    output_anli_path = './data/anli_only_reg'
