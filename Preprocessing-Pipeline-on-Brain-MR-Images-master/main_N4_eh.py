...
def registration_ants_f(m_img_path,m_seg_path, save_path, f_img_path):
    ...
    ants.image_write(warped_label, save_path)
    return
...
if __name__ == '__main__':
    ...
    # input and anli
    input_anli_path = '/home/zhenghuadong/project/Preprocessing-Pipeline-on-Brain-MR-Images-master/data_from_matlab/reg_sk/'
    output_anli_path = './data/anli_prep_reg_sk_N4_eh'
    ...
    for anli_dir in input_anli_list:
        ...
        #         registration_ants_f(dstFilePath, dstFilePath, refPath)
        #     except RuntimeError:
        ...
        #         for i in range(4):
        #             print(str(i+1))
        #             bet(dstFilePath, dstFilePath, frac=0.3)
        #     except RuntimeError:
        #         logging.warning('Failed on: {}'.format(regFilePath))

        # Bias correction
        bcFiles = list()
        for stripFile in niiGzFiles:
