...
# 保存所有的案例，三个模态的或者其他
output_dir = './data_dicom2nii/output/'
output_dir_4 = './data_dicom2nii/output_4/'
output_dir_2 = './data_dicom2nii/output_2/'
output_dir_others = './data_dicom2nii/output_others/'
